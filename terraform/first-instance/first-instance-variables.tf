...
# if you are trying to set up an instance in a region other than Porirua
# change the "default" value of any of the variables below.
...
variable "volume_image_ID" {
  default = "4c70e024-7cd0-4a88-a0bc-ec22814c8bd6"
}
...
variable "compute_image_ID" {
  default = "9a2e683c-6680-4169-8f4a-0cea4ebdaed4"
}

variable "compute_flavor_ID" {
  default = "28153197-6690-4485-9dbc-fc24489b0683"
}
